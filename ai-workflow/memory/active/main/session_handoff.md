...
M-001 컨셉 정리 진행 중. 컨셉은 **v0.24**, `ai-workflow/wiki/concepts/` 아래 **8개 문서**로
...
- 확정 결정 **45가지**(D1~D45)는 §0.2, 실패 방식 15종은 §0.3, 미결 **35건**은 §15(`open-issues.md`).
- **컨셉 판단이 남은 것은 3건뿐**(O21·O38·O7). 나머지는 실데이터 임계값·M-003 설계·보류다.
- 닫힌 쟁점 20건: O4 · O1 · O2 · O3 · O5 · O13 · O17 · O19 · O20 · O24 · O25 · O26 · O27 · O34 · O35 · O39 · O40 · O43 · O48.
