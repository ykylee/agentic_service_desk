...
M-001 컨셉 정리 진행 중. 컨셉은 **v0.21**, `ai-workflow/wiki/concepts/` 아래 **8개 문서**로
...
- 확정 결정 **36가지**(D1~D36)는 §0.2, 실패 방식 15종은 §0.3, 미결 **37건**은 §15(`open-issues.md`).
- 닫힌 쟁점: O1 · O2 · O3 · O5 · O13 · O17 · O19 · O20 · O24 · O25 · O26 · O34 · O35 · O39 · O40 · O43 · O48. 다음은 §0.4 의 일곱 건.
...
- [ ] O27 — 사람이 지식 항목을 직접 고치는가 (1인 겸업이면 B안 부담이 크다)
