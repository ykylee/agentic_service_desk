...
M-001 컨셉 정리 진행 중. 컨셉은 **v0.20**, `ai-workflow/wiki/concepts/` 아래 **8개 문서**로
...
- 확정 결정 **33가지**(D1~D33)는 §0.2, 실패 방식 15종은 §0.3, 미결 **39건**은 §15(`open-issues.md`).
- 닫힌 쟁점: O1 · O5 · O13 · O17 · O20 · O24 · O25 · O26 · O34 · O35 · O39 · O40 · O43 · O48. 다음은 §0.4 의 일곱 건.
