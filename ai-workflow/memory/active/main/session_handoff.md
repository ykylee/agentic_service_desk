...
다음 착수 지점은 **WBS-4.1.1 프로젝트 골격**이다. WBS 는 최상위 8 · **leaf 40** 이고
...
- [ ] **WBS-4.1.1 프로젝트 골격** — Python 패키지, 설정, 온라인/배치 진입점 분리
- [ ] 이어서 4.1.2 어댑터(읽기 표면 XR-1~4) · 4.1.3 LLM 게이트웨이 · 4.1.4 저장소 골격
