...
M-001 컨셉 정리 진행 중. 컨셉은 **v0.22**, `ai-workflow/wiki/concepts/` 아래 **8개 문서**로
...
- 확정 결정 **39가지**(D1~D39)는 §0.2, 실패 방식 15종은 §0.3, 미결 **36건**은 §15(`open-issues.md`).
- 닫힌 쟁점 18건: O1 · O2 · O3 · O5 · O13 · O17 · O19 · O20 · O24 · O25 · O26 · O27 · O34 · O35 · O39 · O40 · O43 · O48.
...
- [ ] O4 — 승격이 자동인가 사람 승인인가 (사실상 수렴했으나 명시적으로 안 닫음)
