...
M-001 컨셉 정리 진행 중. 컨셉은 **v0.16**, `ai-workflow/wiki/concepts/` 아래 **8개 문서**로
...
- 확정 결정 **23가지**(D1~D23)는 §0.2, 실패 방식 10종은 §0.3, 미결 **41건**은 §15(`open-issues.md`).
- 닫힌 쟁점: O1 · O13 · O17 · O24 · O34 · O35 · O40. 다음은 §0.4 의 일곱 건.
...
- [ ] O48 — 국면 전환 판정 (D22·D14·O8 이 모두 국면에 매달려 있는데 전환 주체가 없다)
- [ ] O43 — 형식적 승인 방지 (초안을 읽지 않고 승인하면 되먹임 차단이 뚫린다)
- [ ] O41 — 커밋 위생 확인 — **사용자의 실제 저장소 히스토리 표본이 필요하다**
- [ ] O20 — 칼럼의 의견·해석 허용 범위 (P1~P5 는 사실 진술을 전제하므로 칼럼에 그대로 안 쓰인다)
